...
public class TelaContaInvestimento extends Composite {
	 ...
	 * @param style
	 */
	public TelaContaInvestimento(Composite parent, int style) {
		super(parent, style);
		setLayout(new BorderLayout(0, 0));
		
		Composite titulo = new CompositeTitle(this, SWT.NONE, Constante.TituloTela.TITULO_CONTA_INVESTIMENTO);
