...
import br.com.treinar.agenda.model.Pessoa;
...
public class FuncionarioEndpoint {
	...
	public Response create(Pessoa entity) {
		...
		return Response.created(
				UriBuilder.fromResource(FuncionarioEndpoint.class)
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Pessoa> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT f FROM Funcionario f WHERE f.id = :entityId ORDER BY f.id",
						Pessoa.class);
	...
	public List<Pessoa> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Pessoa> findAllQuery = em.createQuery(
				"SELECT DISTINCT f FROM Funcionario f ORDER BY f.id",
				Pessoa.class);
